    ...
    <div className="blog-container">
      <div className="blog-qa">
        ...
        <p>
          ...
          end.One of the biggest advantages of using React is that you can
          infuse HTML code with JavaScript.
          <br />
          Users can create a representation of a DOM node by declaring the
          Element function in React.
        </p>
      </div>
      <div className="blog-qa">
        <h2>
        ...
        <p>
          ...
          can be described as an object of a collection of observed features
          that control the component’s behavior. In other words, the component’s
          state is an entity with some details that can alter during the
          component’s lifetime. This data is kept inside a component. This
          particular aspect is local or owned. The component itself uses the
          setStatus function to update the state.
          <br />
          <strong>Props</strong>React is a library focused on components that
          separate the user interface into reusable little bits. These
          components have to transmit (send data to each other) in some cases,
          and the way to transmit data among components is through props.
          “Props” is a special React keyword for proprietary purposes, used for
          data transmission from component to component. But the key part of
          this is the transmission of data with props in a uniform flow.
          (parent-to-child route) In addition, props data are read-only, meaning
          that parent data cannot be modified by child elements.
        </p>
      </div>
      <div className="blog-qa">
        {" "}
        ...
        <p>
          <strong>Answer: </strong>Here is some use case of useEffect except
          load api data.
          <br />
          ...
          fetch() call. We are sending the fetched data to a child component,
          and whenever that data is changed, the child component re-process it.
          <br />
        </p>
      </div>
    </div>
